...
import image7 from '../asset/swap_shop.JPG';
import image8 from '../asset/book_search.JPG';
    ...
    <div>
      ...
      <div className= "projects">
        ...
        <div className="card" style={{width: '29rem'}}>
            ...
            <div className="card-body">    
              <h5 className="card-title">Swap Shop</h5>         
              <p>Deployed URL :<a href="https://young-earth-93319.herokuapp.com/" className="card-link">Visit Now 🙂</a></p>
        ...
        <div className="card" style={{width: '29rem'}}>
            ...
            <div className="card-body">    
              <h5 className="card-title">Google Book Search Engine</h5>         
              <p>Deployed URL :<a href="https://obscure-everglades-87685.herokuapp.com/" className="card-link">Visit Now 🙂</a></p>
              <p>GitHub Repo :<a href="https://github.com/mikehui1124/Book_search_engine " className="card-link">View Source Code 🙂</a></p>
